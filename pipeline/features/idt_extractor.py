...
class IdtExtractor(Extractor):
    ...
    def prepare_train_features(self, return_dict=False):
        train_features = self.load_features(self.data_helper.feature_path + sep + FEATURE_TRAIN_PREFIX, return_dict=return_dict)
    ...
    def prepare_test_features(self):
        test_features = self.load_features(self.data_helper.feature_path + sep + FEATURE_TEST_PREFIX, return_dict=True)
